...
export function SettingsRow({ icon, title, subtitle }: SettingsRowProps) {
  return (
    <div className="flex items-center gap-3 rounded-card bg-tranparent px-4 py-1">
      <div className="flex size-12 items-center justify-center rounded-plan bg-surface text-brand-green text-xl">
        {icon}
      </div>
